const beers = [
  ...
  },
  {
    ...
    imageUrl:
      "https://fiskarsinpanimo.fi/wp-content/uploads/2018/11/virvatuli-tolkki2-033.png",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "En Ipa från Lappland. Första tanken var att den var för fruktig och blir låga betyg men sakta men säkert blir den bättre.",
    imageUrl:
  ...
  },
  {
    ...
    rating: 1,
    comment:
      "Troligen den värsta öl jag nånsin druckit! Rekommenderar inte ens till mina värsta fiender. Blir en 0:a men skulle gärna ge en 0:a.",
    imageUrl:
